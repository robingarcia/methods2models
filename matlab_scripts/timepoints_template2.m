...
for i = 1:n        % i = Number of cells
    ...
    [pks,locs, widths, proms]=findpeaks(statevalues{1,i}((o:end),j), 'MinPeakDistance', 28, 'MinPeakHeight',0.05);
    ...
    % M/G1-Transition
    %Cdc20ATransMinus = G{1,i}{2,12}(end);
...
RESULTS = table(Cells, Period, GrowthRate);
disp(RESULTS);
